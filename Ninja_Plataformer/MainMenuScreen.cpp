...
void MainMenuScreen::initUI()
{
    ...
    CEGUI::PushButton* levelEditorButton = static_cast<CEGUI::PushButton*>(m_gui.createWidget("TaharezLook/Button", glm::vec4(0.45f, 0.56f, 0.1f, 0.05f), glm::vec4(0.0f), "LevelEditorButton"));
...
bool MainMenuScreen::onLevelEditorClicked(const CEGUI::EventArgs& e)
{
